--``
-- SELECT CURRENT_DATE;psql -U dev -f ./db/noteful.2.sql -d noteful-app
...
-- -- -- -- get all notes
-- SELECT * FROM notes;
-- SELECT * FROM notes WHERE title = '9 life lessons learned from cats';
...
-- get all notes w folders
-- Select * FROM notes
-- INNER JOIN folders ON notes.folder_id = folders.id;

-- get all notes, show folders if they exist otherwise NULL
-- SELECT * FROM notes
...
-- INSERT INTO tags (name) VALUES ('wham'), ('bam'), ('pow'), ('wow');

-- INSERT INTO notes_tags (note_id, tag_id) VALUES (1000, 2), (1001, 2), (1002, 4), (1003, 4), (1004, 2), (1005, 1), (1006, 1), (1007, 3), (1008, 3), (1009, 1);
...
('11 ways investing in cats can make you a millionaire', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 100), ('Why you should forget everything you learned about cats', 'Posuere sollicitudin aliquam ultrices sagittis orci a. Feugiat sed lectus vestibulum mattis ullamcorper velit. Odio pellentesque diam volutpat commodo sed egestas egestas fringilla. Velit egestas dui id ornare arcu odio. Molestie at elementum eu facilisis sed odio morbi. Tempor nec feugiat nisl pretium. At tempor commodo ullamcorper a lacus. Egestas dui id ornare arcu odio. Id cursus metus aliquam eleifend. Vitae sapien pellentesque habitant morbi tristique. Dis parturient montes nascetur ridiculus. Egestas egestas fringilla phasellus faucibus scelerisque eleifend. Aliquam faucibus purus in massa tempor nec feugiat nisl.', 102);
